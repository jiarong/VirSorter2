...
def make_config(db_dir, seqfile, config_f, include_groups, tmpdir, 
                ...
                viral_gene_required=False, prep_for_dramv=False, 
                threads=None, max_orf_per_seq=20, label='', 
                keep_original_seq=False, high_confidence_only=False, 
                exclude_lt2gene=False, seqname_suffix_off=False, 
                viral_gene_enrich_off=False):
    '''
    ...
    config['VIRAL_GENE_ENRICH_OFF'] = viral_gene_enrich_off
